((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    right() {
      this._board && this._board.cur && this._board.cur.moveRight()
    },

    left() {
      this._board && this._board.cur && this._board.cur.moveLeft()
    },

    rotate() {
      this._board && this._board.cur && this._board.cur.rotate('left')
    },

    drop() {
      this._board && this._board.cur && this._board.cur.drop()
    },
